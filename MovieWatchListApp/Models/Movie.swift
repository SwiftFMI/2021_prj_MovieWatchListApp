...
struct MockModel {
    var listOfMovies = [MovieSearch]()
    var movieSearchResult = MovieSearch(page: 1, results: [
        ...
        Movie(id:NSUUID().uuidString,movieId:622230,title: "LEGO Marvel Spider-Man: Vexed by Venom",
              posterPath:"/gTo2r8nNU3ZYAS6DqdeSp1VEqkq.jpg", summary:"Thanks to Green Goblin and Venom, tech theft is now at an all-time high. Can our Friendly Neighborhood Spider-Man put an end to their mysterious villainous scheme before all of New York City is destroyed?", language: "en", genresIDs:[99,10770],rating: 6.1, releaseDate:"2016-03-06")], totalPages: 9,totalResults: 166)
